  ...
  <div class="row justify-content-center">
    <div class="col-10">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="cabunpontocomApp.clientOrderStartForm.home.createOrEditLabel"
          data-cy="ClientOrderStartFormCreateUpdateHeading"
          v-text="$t('cabunpontocomApp.clientOrderStartForm.home.createOrEditLabel')"
        >
              ...
              <div v-if="clientOrderProcess.clientOrder">
                <div class="form-group">
                  <label
                    ...
                    v-text="$t('cabunpontocomApp.clientOrderStartForm.orderID')"
                ...
                <div class="form-group">
                  <label
                    class="form-control-label"
                    v-text="$t('cabunpontocomApp.clientOrderStartForm.orderDate')"
                ...
                <div class="form-group">
                  <label
                    class="form-control-label"
                    v-text="$t('cabunpontocomApp.clientOrderStartForm.clientName')"
