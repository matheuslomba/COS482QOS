...
class ClientOrderResourceIT {
    ...
    private static final String DEFAULT_ORDER_COMPONENTS = "AAAAAAAAAA";
    private static final String UPDATED_ORDER_COMPONENTS = "BBBBBBBBBB";

    private static final String DEFAULT_ORDER_PRICE = "AAAAAAAAAA";
    private static final String UPDATED_ORDER_PRICE = "BBBBBBBBBB";

    private static final Integer DEFAULT_NUM_ITEMS = 1;
    private static final Integer UPDATED_NUM_ITEMS = 2;
    ...
    public static ClientOrder createEntity(EntityManager em) {
        ClientOrder clientOrder = new ClientOrder()
            ...
            .orderComponents(DEFAULT_ORDER_COMPONENTS)
    ...
    public static ClientOrder createUpdatedEntity(EntityManager em) {
        ClientOrder clientOrder = new ClientOrder()
            ...
            .orderComponents(UPDATED_ORDER_COMPONENTS)
            .orderPrice(UPDATED_ORDER_PRICE)
            .numItems(UPDATED_NUM_ITEMS)
    ...
    void getAllClientOrders() throws Exception {
        ...
        restClientOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].orderComponents").value(hasItem(DEFAULT_ORDER_COMPONENTS)))
            .andExpect(jsonPath("$.[*].orderPrice").value(hasItem(DEFAULT_ORDER_PRICE)))
            .andExpect(jsonPath("$.[*].numItems").value(hasItem(DEFAULT_NUM_ITEMS)))
    ...
    void getClientOrder() throws Exception {
        ...
        restClientOrderMockMvc
            ...
            .andExpect(jsonPath("$.orderComponents").value(DEFAULT_ORDER_COMPONENTS))
            .andExpect(jsonPath("$.orderPrice").value(DEFAULT_ORDER_PRICE))
            .andExpect(jsonPath("$.numItems").value(DEFAULT_NUM_ITEMS))
