...
public class ConfirmationEmailDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        String subject = "[Cabunpontocom] Your Order is on the way! " + clientOrder.getOrderID();
        Context context = new Context(Locale.getDefault());
        context.setVariable("clientOrder", clientOrder);
        String content = templateEngine.process("clientOrderProcess/clientOrderConfirmationEmail", context);
